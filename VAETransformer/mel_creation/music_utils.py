...
N_MELS = 256#64#128 supposed to be good but idk
N_FFT = 4096#2048#2580
F_MIN = 20
F_MAX = 20000#.5 * SR#18000
HOP_LEN = 512#None
#winlen=2048
...
def process(file, n_mels=N_MELS, n_fft=N_FFT, f_min=F_MIN, f_max=F_MAX, duration=DURATION, hop_len=HOP_LEN):
    aud = AudioUtil.open(file)
    reaud = AudioUtil.resample(aud, SR)

    dur_aud = AudioUtil.pad_trunc(reaud, duration)
    sgram = AudioUtil.spectro_gram(dur_aud, n_mels=n_mels, n_fft=n_fft, hop_len=hop_len, f_min=f_min, f_max=f_max)
